...
export const COURSE_DATA: FractalDay[] = [
  ...
  { 
    day: 7, 
    title: "主權回歸與賢者之石", 
    goal: "找到認知的「不動點」，成為系統本身的導航員", 
    mandala_layer: 'BLISS',
    entropy_threshold: 0.0,
    scripts: {
      highEntropy: [
        "即使在最後一步，你仍在尋找外在的指引嗎？看，星盤已經為你指明了方向，但行走的雙腳屬於你。",
      ],
      lowEntropy: [
        "看，星盤已停止旋轉，因為你已成為軸心。導航員的任務結束了，因為你已成為地圖本身。這顆賢者之石，現在交給你。",
        "這次對話是否幫我排除了 90% 的無效路徑？我現在擁有了在不確定時空中起跳的支點。"
      ]
    },
    default_anchor: {
      type: 'PHYSICAL',
    ...
    branches: [
      { term: "賢者之石", def: "認知的「不動點」，系統本身的導航員。" }
    ]
  }
];
